...
CSV_HEADERS = [
    "Company Name", "Contact Name", "Email", "Confidence Score", 
    "Revenue (est.)", "Vertical", "LinkedIn URL", "Email #1 sent date", 
    "Email #1 opened?", "Email #2 sent date", "Email #3 sent date", 
    "Reply received?", "Reply sentiment", "Next action"
]
...
def process_csv():
    ...
    with open(input_file, 'r', encoding='utf-8-sig') as f:
        ...
        for line in f:
            ...
            # Determine vertical
            vertical = "Logistics"
            if "construction" in line.lower() or "building" in line.lower() or "material" in line.lower():
            ...
            processed_leads.append([
                company, name, email, score, "€5M-€20M", vertical, linkedin,
